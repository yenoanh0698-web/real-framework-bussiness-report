    ...
    <div className="flex-col gap-4">
      ...
      <div className="grid-2 gap-4">
        <div className="card">
          ...
          <div style={{ height: 350 }}>
            <ResponsiveContainer>
              <ComposedChart data={mockPareto} margin={{ top: 20, right: 20, bottom: 40, left: 20 }}>
                <CartesianGrid stroke="#f5f5f5" />
                <XAxis dataKey="name" interval={0} tick={{ fontSize: 11, angle: -30, textAnchor: 'end' }} height={60} />
                <YAxis yAxisId="left" />
